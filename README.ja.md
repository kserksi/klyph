...
Klyph のソースコードは [Apache License 2.0](LICENSE) で提供されます。同梱フォントには別途 SIL Open Font License 1.1 が適用されます。Hero 背景画像は **Lilac** 氏の作品です（[Pixiv 作品 #146748240](https://www.pixiv.net/artworks/146748240)）。画像の著作権、所有権およびその他のすべての権利は作者に帰属し、Apache-2.0 の対象外です。クレジットの詳細は `fonts/OFL-kaku.txt`、`fonts/OFL-maru.txt`、`/licenses` ページを参照してください。
